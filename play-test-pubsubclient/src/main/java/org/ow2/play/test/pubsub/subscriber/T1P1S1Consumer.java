...
final class T1P1S1Consumer implements INotificationConsumer {
	/**
	 * 
	 */
	 ...
	 */
	T1P1S1Consumer(PubSubClientServer pubSubClientServer) {
		this.pubSubClientServer = pubSubClientServer;
		this.logger = LoggerFactory.getLogger(T1P1S1Consumer.class);
